...
def plotSpectrums(data1, data2=None, sampling_rate=5000, nperseg=1000, pltobj=None):
    ...
    if pltobj is None:
        plt.plot(filt_spec1[0], filt_spec1[1])
    else:
        pltobj.plot(filt_spec1[0], filt_spec1[1])
    ...
    if pltobj is None:
        plt.plot(filt_spec2[0], filt_spec2[1])
    else:
        pltobj.plot(filt_spec2[0], filt_spec2[1])
...
def getNotchFilterPolinomials(freqs, sample_freq, Q_factor):
    polinomials = []
