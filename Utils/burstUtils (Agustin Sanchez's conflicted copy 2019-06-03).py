...
def digitizeSpikeFreqs(spike_freq_dict, step, time_length=None, count=False, freq_threshold=150):
    ...
    rg = np.arange(0, time_length+step, step)
    binned_spike_freq_dict = {}
    ...
    for key, item in spike_freq_dict.items():
        ...
        binned_spike_freq_dict[key] = np.array([rg[:-1], deepcopy(freqs)])
