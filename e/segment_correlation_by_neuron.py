...
for j in range(6, 8):
    ...
    good_neurons = cdb.loc[filename].index[cdb.loc[filename, 'neuron_is_good'].values.astype(bool)].values
    crawling_interval = [cdb.loc[filename].start_time.iloc[0], cdb.loc[filename].end_time.iloc[0]]
