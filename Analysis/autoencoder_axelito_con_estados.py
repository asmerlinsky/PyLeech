...
import PyLeech.Utils.burstClasses
...
if __name__ == "__main__":
    ...
    for fn in run_list:
        ...
        binned_sfd = burstUtils.processSpikeFreqDict(spike_freq_dict, bin_step, time_interval=crawling_interval,
                                                     time_length=time_length, selected_neurons=selected_neurons)
        sfa = burstUtils.processed_sfd_to_array(binned_sfd)

        smoothed_sfa = burstUtils.processed_sfd_to_array(burstUtils.smoothBinnedSpikeFreqDict(binned_sfd, 1, 20, bin_step))
