...
import PyLeech.Utils.burstUtils as burstUtils1
import PyLeech.Utils.abfUtils as abfUtils
import matplotlib.pyplot as plt
import glob
from importlib import reload
import numpy as np
import PyLeech.filterUtils as fU
...
new_sl1, new_sl2 = burstUtils1.resampleArrayList(segment_list[0], segment_list[1])
...
for j in range(6,8):
    ...
    binned_sfd = burstUtils1.digitizeSpikeFreqs(burst_object.spike_freq_dict, time[-1], 5 / fs, count=True)
    print('file %i' % j)
